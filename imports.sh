...
terraform import -var-file=environments/terraform.tfvars module.bucket_2dlru2rs.aws_s3_bucket_versioning.this 2dlru2rs-private-runner-storage-backend
...
terraform import -var-file=environments/terraform.tfvars module.bucket_37lxrdhe.aws_s3_bucket_versioning.this 37lxrdhe-private-runner-storage-backend